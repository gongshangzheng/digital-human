...
- [ ] 3.4 首次推送后启用 GitHub Pages 的 workflow 部署源；如权限或仓库设置阻断，则暂停部署步骤并向用户报告。
...
- [ ] 4.4 推送后检查 GitHub Actions 首次部署、线上文档首页 / 深链接 / 图片；记录非文档模块的无后端边界。
- [ ] 4.5 运行 `openspec validate --change sync-projflow-round6`，提交共享同步改动并按流程归档。
