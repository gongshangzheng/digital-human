...
- [x] 2.1 写 `management/docs/实习复盘/数字人身份.md` 正文（7 节：为什么重要 / 身份表示与渲染后端 / 身份注入与保持 / 一致性度量 / Avatar Forcing 上的身份改进〔5 子节〕/ 可能的改进方向 / 汇报要点），数字全部溯源整理产物
- [x] 2.2 自查：结构契约对齐、无编造数字、无越界结论；openspec validate 通过并提交
