...
- 正文目标路径：`management/docs/实习复盘/数字人介绍与技术路线.md`；素材路径：`.../数字人介绍与技术路线-素材.md`
...
- **D2 素材与正文都进 docs**：整理产物 `management/docs/实习复盘/数字人介绍与技术路线-素材.md`（证据附件），正文 `management/docs/实习复盘/数字人介绍与技术路线.md`；change 目录只放计划（proposal/design/tasks）
