...
- 双层流程（D0）：先「资料整理」产出 `整理-身份一致性.md`（本 change 目录内），用户确认后才进入「动笔写作」。

## Goals / Non-Goals

**Goals:**
- 整理产物：全部实验数据表（原始数字）、术语与变量定义（z_S/r_d/模长/方向）、事实分级清单
...
- **D1 整理产物放 change 目录**：`openspec/changes/docs-intern-identity/整理-身份一致性.md`——正文写完后它是证据附件，不进 management/docs/
